        ...
        async function connectWallet() {
            try {
                ...
                try {
                    ...
                    showError(getErrorMessage(error) || 'Failed to connect wallet. Please try again.');  // ✅ Safe message
                }
            } catch (err) {
        ...
        socket.on('loginSuccess', async (data) => {
            ...
            try {
                // Get reCAPTCHA token
                const recaptchaToken = window.recaptchaEnabled ? await getRecaptchaToken('login') : null;
                ...
                if (result.success) {
                    ...
                    showError(getErrorMessage(result.error) || 'Authentication failed. Please try again.');
                    document.getElementById('connectWalletBtn').disabled = false;
                    document.getElementById('connectWalletBtn').innerHTML = '<img src="data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 128 128%27 fill=%27%23AB9FF2%27%3E%3Cpath d=%27M96 24c17.7 0 32 14.3 32 32v48c0 17.7-14.3 32-32 32H32C14.3 136 0 121.7 0 104V56c0-17.7 14.3-32 32-32h64zm-32 40c0 8.8-7.2 16-16 16s-16-7.2-16-16 7.2-16 16-16 16 7.2 16 16zm32 0c0 8.8-7.2 16-16 16s-16-7.2-16-16 7.2-16 16-16 16 7.2 16 16z%27/%3E%3C/svg%3E" alt="Phantom" class="wallet-icon">Connect Phantom Wallet';
                }
