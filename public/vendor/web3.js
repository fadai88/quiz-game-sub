var solanaWeb3 = (function (exports) {
  ...
  function combineCodec(encoder, decoder) {
    ...
    if (
      ...
      throw new SolanaError(
        ...
        { decoderMaxSize: decoder.maxSize, encoderMaxSize: encoder.maxSize }
      );
    }
    return {
      ...decoder,
  ...
  const COMMON_HTTP_HEADERS = { "solana-client": `js/${"1.0.0-maintenance"}` };
  class Connection {
    ...
    async getRecentBlockhashAndContext(commitment) {
      ...
      return {
        context: context,
        value: { blockhash: blockhash, feeCalculator: feeCalculator },
      };
    }
    ...
    static createLookupTable(params) {
      const [lookupTableAddress, bumpSeed] = PublicKey.findProgramAddressSync(
        [
          ...
          getU64Encoder().encode(params.recentSlot),
        ],
        this.programId
      );
  ...
  class Secp256k1Program {
    ...
    static publicKeyToEthAddress(publicKey) {
      ...
      try {
        return bufferExports.Buffer.from(keccak_256(toBuffer(publicKey))).slice(
