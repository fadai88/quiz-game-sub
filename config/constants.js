...
if (ENVIRONMENT === 'production') {
    ...
    console.log('   reCAPTCHA:', process.env.ENABLE_RECAPTCHA === 'true' ? 'ENABLED' : 'DISABLED');
    console.log('   Redis:', process.env.REDIS_PASSWORD ? 'PASSWORD PROTECTED' : '⚠️  NO PASSWORD (insecure - dev only)');
}
